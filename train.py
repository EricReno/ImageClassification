...
def train():
    ...
    val_dataset = Fire(data_dir = os.path.join(os.getcwd(), 'data'),
                       transform = transform,
                       is_train = False)
    train_dataset = Fire(data_dir = os.path.join(os.getcwd(), 'data'),
                         transform = transform,
                         is_train = True)
    ...
    for epoch in range(args.max_epoch):
        ckpt_path = os.path.join(os.getcwd(), 'results', '{}.pth'.format(epoch))
        ...
        if acc > max_acc:
            max_acc = acc
            ckpt_path = os.path.join(os.getcwd(), 'results', '{}.pth'.format(epoch+1))
